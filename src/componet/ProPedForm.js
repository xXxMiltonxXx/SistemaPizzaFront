...
export default function ProPedForm() {
    //captura los datos
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await fetch('http://localhost:4000/usuario/proped', {
            method: 'POST',
                    ...
                    <CardContent>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <Select name='code_usuario' value={entrenador.code_usuario} sx={{ display: 'block', margin: '.5rem 0' }} onChange={handleChange} >
                                <MenuItem value={1} >Pizza 1 revanada Queso</MenuItem>
                                <MenuItem value={2} >Pizza 1 revanadaPeperoni</MenuItem>
                                <MenuItem value={3} >Pizza 1 revanada carne</MenuItem>
                            </Select>
                        ...
                        <Button variant='contained' color='primary' onClick={()=> navigate('/listaPedidos')} >
                             Terminar
                        </Button>
                    </CardContent>
                </Card>
