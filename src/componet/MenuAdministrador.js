...
export default function MenuAdministrador() {
    ...
    return (
        <>
            <Grid >
                <h1 style={h1Styles}>Bienvenido Administrador</h1>
            ...
            <div>
                ...
                >
                    <div style={buttonContainerStyles}>
                        ...
                        <Button variant="contained" style={buttonStyles} onClick={() => navigate('/listaUsuario')}>Administrador</Button>
                        <Button variant="contained" style={buttonStyles} onClick={() => navigate('/listaEmpleado')}>Empleado</Button>
                        <Button variant="contained" style={buttonStyles} onClick={() => navigate('/listaProductos')}>Producto</Button>
                        <Button variant="contained" style={buttonStyles} onClick={() => navigate('/listaPromociones')}>Promocion</Button>
                    </div>
                </Drawer>
                <main>
                    <Typography variant='h4' sx={{ flexGrow: 1, textAlign: "center" }} >Seleccione una opción </Typography>
                    <p style={{marginTop: '50px',marginLeft: '30%'}}>Como usuario administrador tiene multiples opciones como agregar</p>
                </main>
            </div>
        </>
    )
